...
test("calc-impact-cases-for-Ventilators-by-requested-time", () => {
  const value = estimateData(mockData.data).impact
    .casesForVentilatorsByRequestedTime;
  expect(value).toBe(
    mockData.estimate.impact.casesForVentilatorsByRequestedTime
  );
});
...
test("calc-severeImpact-infections-by-requested-time", () => {
  const value = estimateData(mockData.data).severeImpact
...
test("calc-severeImpact-hospital-beds-by-requested-time", () => {
  ...
  expect(value).toBe(
    mockData.estimate.severeImpact.hospitalBedsByRequestedTime
  );
});
...
test("calc-severeImpact-cases-for-Ventilators-by-requested-time", () => {
  const value = estimateData(mockData.data).severeImpact
    .casesForVentilatorsByRequestedTime;
  expect(value).toBe(
    mockData.estimate.severeImpact.casesForVentilatorsByRequestedTime
  );
});
